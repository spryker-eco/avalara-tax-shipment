...
namespace SprykerEcoTest\Zed\AvalaraTaxShipmentTax\Business;
...
class AvalaraTaxShipmentTaxFacadeTest extends Unit
{
    /**
    ...
    /**
     * @var \SprykerEcoTest\Zed\AvalaraTaxShipmentTax\AvalaraTaxShipmentTaxBusinessTester
     */
    protected $tester;
    ...
    public function testExpandAvalaraCreateTransactionRequestWillExpandAvalaraCreateTransactionRequestTransferWithShippingMethods(): void
    {
        ...
        // Act
        $avalaraCreateTransactionRequestTransfer = $this->tester->getFacade()->expandAvalaraCreateTransactionRequest(
    ...
    public function testCalculateShipmentTaxWillCalculateTaxForMultiAddressShipment(): void
    {
        ...
        $quoteTransfer = (new QuoteBuilder())
            ->withExpense($expenseTransferMi->toArray())
            ->withAnotherExpense($expenseTransferNy->toArray())
            ->build();
        ...
        $resultExpenseTransferMi = $this->findExpenseTransferByShipmentTransfer($resultShipmentTransferMi, $calculableObjectTransfer->getOriginalQuote()->getExpenses());
        ...
        $resultExpenseTransferNy = $this->findExpenseTransferByShipmentTransfer($resultShipmentTransferNy, $calculableObjectTransfer->getOriginalQuote()->getExpenses());
    ...
    public function testCalculateShipmentTaxWillCalculateTaxForSingleAddressShipment(): void
    {
        ...
        $expenseTransferMi = $this->createExpenseTransfer($shipmentTransfer);
        $quoteTransfer = (new QuoteBuilder())
            ->withExpense($expenseTransferMi->toArray())
            ->build();
        ...
        foreach ($calculableObjectTransfer->getOriginalQuote()->getExpenses() as $expenseTransfer) {
     ...
     */
    protected function createCalculableObjectTransfer(array $itemTransfers = []): CalculableObjectTransfer
    {
        $calculableObjectTransfer = (new CalculableObjectBuilder([
            CalculableObjectTransfer::PRICE_MODE => static::PRICE_MODE_GROSS,
        ]))->build();

        return $calculableObjectTransfer->setItems(new ArrayObject($itemTransfers));
    }
